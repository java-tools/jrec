...
def test():
	...
	if window('Record Editor'):
		...
		select('Table', 'rows:[3,4,5,6,7,8,9,10],columns:[10 - 35|Loc Name]')
		select_menu(commonBits.fl('View') + '>>' + commonBits.fl('Table View #{Selected Records#}'))
##		select('Table2', 'rows:[3,4,5,6,7,8,9,10],columns:[10 - 35|Loc Name]')
		select('Table', 'cell:10 - 35|Loc Name,2(Penrith)')
...
##		select('Table1', 'cell:10 - 35|Loc Name,2(Penrith)')
		...
		select('Table', 'cell:10 - 35|Loc Name,2(Penrith)')
		select('Table', 'cell:45 - 40|Loc Addr Ln1,3(Marayong)')
		...
		select('Table', 'cell:45 - 40|Loc Addr Ln1,3(Marayong)')
		select('Table', 'cell:45 - 40|Loc Addr Ln1,3(Marayong)')
		rightclick('Table', '45 - 40|Loc Addr Ln1,2')
		select('Table', 'cell:45 - 40|Loc Addr Ln1,3(Marayong)')
		select('Table', 'cell:45 - 40|Loc Addr Ln1,3(Marayong)')
		select_menu(commonBits.fl('Edit') + '>>' + commonBits.fl('Show / Hide Fields'))
##		select('Table1', 'cell:45 - 40|Loc Addr Ln1,3(Marayong)')
		...
		click(commonBits.fl('Go'))
		select('Table', 'cell:45 - 40|Loc Addr Ln1,3(Marayong)')
		select('Table', 'cell:125 - 35|Loc Addr Ln3,3(Marayong)')
		...
		select('Table', 'cell:125 - 35|Loc Addr Ln3,3(Marayong)')
		rightclick('Table', '160 - 10|Loc Postcode,4')
		select_menu(commonBits.fl('Show Column') + '>>Brand Id')
		select('Table', 'cell:125 - 35|Loc Addr Ln3,4(Botany)')
		...
		select('Table', 'cell:125 - 35|Loc Addr Ln3,4(Botany)')
		select_menu(commonBits.fl('Edit') + '>>' + commonBits.fl('Show / Hide Fields'))
##		select('Table1', 'cell:125 - 35|Loc Addr Ln3,4(Botany)')
		select('Table', 'cell:' + commonBits.fl('Field') + ',3(Loc Name)')
		assert_p('Table', 'Content', '[[Brand Id, true], [Loc Nbr, true], [Loc Type, false], [Loc Name, true], [Loc Addr Ln1, true], [Loc Addr Ln2, false], [Loc Addr Ln3, true], [Loc Postcode, true], [Loc State, true], [Loc Actv Ind, true]]')
##		select('Table', 'true', commonBits.fl('Show') + ',2')
		select('Table', 'cell:' + commonBits.fl('Show') + ',2(true)')
		click(commonBits.fl('Go'))
		select('Table', 'cell:125 - 35|Loc Addr Ln3,4(Botany)')
		select('Table', 'cell:45 - 40|Loc Addr Ln1,4(Building B,  Portside DC)')
		...
		select('Table', 'cell:45 - 40|Loc Addr Ln1,4(Building B,  Portside DC)')
		select_menu(commonBits.fl('Edit') + '>>' + commonBits.fl('Show / Hide Fields'))
##		select('Table1', 'cell:45 - 40|Loc Addr Ln1,4(Building B,  Portside DC)')
		select('Table', 'cell:' + commonBits.fl('Field') + ',5(Loc Addr Ln2)')
		assert_p('Table', 'Content', '[[Brand Id, true], [Loc Nbr, true], [Loc Type, true], [Loc Name, true], [Loc Addr Ln1, true], [Loc Addr Ln2, false], [Loc Addr Ln3, true], [Loc Postcode, true], [Loc State, true], [Loc Actv Ind, true]]')
		select('Table', 'true', commonBits.fl('Show') + ',5')
		select('Table', 'cell:' + commonBits.fl('Field') + ',6(Loc Addr Ln3)')
		assert_p('Table', 'Content', '[[Brand Id, true], [Loc Nbr, true], [Loc Type, true], [Loc Name, true], [Loc Addr Ln1, true], [Loc Addr Ln2, true], [Loc Addr Ln3, true], [Loc Postcode, true], [Loc State, true], [Loc Actv Ind, true]]')
		select('Table', 'cell:' + commonBits.fl('Field') + ',6(Loc Addr Ln3)')
		click(commonBits.fl('Go'))
		select('Table', 'cell:45 - 40|Loc Addr Ln1,4(Building B,  Portside DC)')
