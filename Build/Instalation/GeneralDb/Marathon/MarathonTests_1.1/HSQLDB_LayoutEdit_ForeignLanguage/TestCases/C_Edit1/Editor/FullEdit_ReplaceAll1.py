...
def test():
	...
	if window('Record Editor'):
		...
		assert_p('Table', 'Text', 'George Street', commonBits.fl('Data') + ',5')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(Balmoral Street)')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',4(West_field Shoppingtown)')
		assert_p('Table', 'Text', 'cell:' + commonBits.fl('Data') + ',4(West_field Shoppingtown)')
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(Matthews Avenue)')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',4(West_field Shopping Centre)')
		assert_p('Table', 'Text', 'cell:' + commonBits.fl('Data') + ',4(West_field Shopping Centre)')
