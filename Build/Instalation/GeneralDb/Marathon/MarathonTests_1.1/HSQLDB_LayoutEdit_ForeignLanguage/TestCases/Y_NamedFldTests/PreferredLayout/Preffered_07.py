...
#		assert_p('Filter.FieldRelationship_JTbl', 'Content', '[[STORE-NO, true, ' + commonBits.fl('Contains') + ', 20], [, true, ' + commonBits.fl('Contains') + ', ], [, true, ' + commonBits.fl('Contains') + ', ], [, true, ' + commonBits.fl('Contains') + ', ]]')
