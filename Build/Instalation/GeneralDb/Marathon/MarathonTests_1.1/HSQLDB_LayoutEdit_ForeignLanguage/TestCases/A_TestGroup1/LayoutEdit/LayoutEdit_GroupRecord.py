...
#		select('ChildRecordsJTbl', 'cell:,0(0)')
		...
		select('RecordFieldsJTbl', 'cell:' + commonBits.fl('FieldName') + ',4(Filler)')
		assert_p('RecordFieldsJTbl', 'RowCount', '9')
		select('RecordFieldsJTbl', 'cell:' + commonBits.fl('FieldName') + ',5(Product)')
		assert_p('RecordFieldsJTbl', 'ColumnCount', '10')
		select('RecordFieldsJTbl', 'cell:' + commonBits.fl('FieldName') + ',5(Product)')
		click('Right')
		##select('TabbedPane', 'Extras')
		select('TabbedPane', commonBits.fl('Fields'))
		select('RecordFieldsJTbl', 'cell:' + commonBits.fl('FieldName') + ',1(Sequence Number)')
		assert_p('RecordFieldsJTbl', 'Text', 'cell:' + commonBits.fl('FieldName') + ',1(Sequence Number)')
