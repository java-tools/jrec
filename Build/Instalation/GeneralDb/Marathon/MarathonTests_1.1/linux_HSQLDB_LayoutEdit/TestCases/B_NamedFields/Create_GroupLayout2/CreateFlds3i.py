...
def test():
	...
	if window('Record Layout Definitions'):
		...
		select('ChildRecordsJTbl', 'zx3xzFLDg777aaaa', 'Tree Parent,1')
		...
		select('ChildRecordsJTbl', 'zx3xzFLDg777aaaa', 'Tree Parent,3')
		select('ChildRecordsJTbl', 'cell:Tree Parent,3(zx3xzFLDg777aaaa)')
		...
		select('ChildRecordsJTbl', 'zx3xzFLDg777bbbb', 'Tree Parent,4')
		...
		select('ChildRecordsJTbl', 'zx3xzFLDg777aaaa', 'Tree Parent,5')
		select('ChildRecordsJTbl', 'cell:Tree Parent,5(zx3xzFLDg777aaaa)')
...
##		assert_p('ChildRecordsJTbl', 'Content', '[[, zx3xzFLD1, , , , , zx3xzFLD2], [, zx3xzFLD2, , , , , zx3xzFLDg777aaaa], [, zx3xzFLDg777aaaa, , , , , ], [, zx3xzFLDg777bbbb, , , , , zx3xzFLDg777aaaa], [, zx3xzFLDg777cccc, , , , , zx3xzFLDg777bbbb], [, zx3xzFLDg777eeee, , , , , zx3xzFLDg777aaaa]]')
		...
		if window('Delete: zx3xzFLDg777bbbb'):
			click('Yes')
		close()
...
##		assert_p('ChildRecordsJTbl', 'Content', '[[, zx3xzFLD1, , , , , zx3xzFLD2], [, zx3xzFLD2, , , , , zx3xzFLDg777aaaa], [, zx3xzFLDg777aaaa, , , , , ], [, zx3xzFLDg777bbbb, , , , , zx3xzFLDg777aaaa], [, zx3xzFLDg777dddd, , , , , zx3xzFLDg777bbbb], [, zx3xzFLDg777eeee, , , , , zx3xzFLDg777aaaa]]')
		...
		if window('Delete: zx3xzFLDg777aaaa'):
			click('Yes')
		close()
		...
		select('ChildRecordsJTbl', 'zx3xzFLDg777dddd', 'Tree Parent,3')
		...
		if window('Delete: zx3xzFLDg777dddd'):
			click('Yes')
		close()
		...
		if window('Delete: zx3xzFLDg777eeee'):
			click('Yes')
		close()
