...
##		select('JTreeTable', 'cell:Tree,4(null)')
		...
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[department, 1, , 410, 410], [name, 2, , Department: 410, Department: 410]]')
		click('Right')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,1(Department: 620)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[department, 1, , 620, 620], [name, 2, , Department: 620, Department: 620]]')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,1(Department: 620)')
		click('Down')
		...
		click('Right')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,3(3990)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 60694698, 60694698], [saleDate, 2, , 40118, 40118], [quantity, 3, , 1, 1], [price, 4, , 3990, 3990]]')
		click('Right')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,1(7980)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[quantity, 1, , 2, 2], [price, 2, , 7980, 7980], [count, 3, , 2, 2]]')
		click('Up')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,1(Department: 620)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[department, 1, , 620, 620], [name, 2, , Department: 620, Department: 620]]')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,1(Department: 620)')
		click('Up')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,0(59)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[store, 1, , 59, 59], [name, 2, , Store: 59, Store: 59]]')
		click('Down')
