...
//			this.tipDetails = tipDetails;
	...
	public ArgumentOption getFileStructureCode() {
		...
		return ArgumentOption.newFileStructureOpt(Integer.toString(fileStructure), Code2JRecordConstants.getJRecordIoTypeName(fileStructure), "", fileStructure);
	}
	...
	public final ArgumentOption getDialect() {
		...
		return new ArgumentOption(Integer.toString(dialect), Code2JRecordConstants.getDialectName(dialect), "", dialect);
	}
