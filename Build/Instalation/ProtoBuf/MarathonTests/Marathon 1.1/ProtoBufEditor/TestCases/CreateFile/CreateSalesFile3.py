...
def test():
	...
	if window(commonBits.applicationName()):
		select('FileNameTxtFld', commonBits.sampleDir() + 'zCcStore.bin')
...
##[[keycode, 1, , 0, 0], [store, 2, , 0, 0], [department, 3, , 0, 0], [saleDate, 4, , 0, 0], [quantity, 5, , 0, 0], [price, 6, , 0, 0]]')
		...
		select('BaseLineAsColumn$LineAsColTbl', '33', 'Data,1')
		select('BaseLineAsColumn$LineAsColTbl', '303', 'Data,2')
		select('BaseLineAsColumn$LineAsColTbl', '30032003', 'Data,3')
		select('BaseLineAsColumn$LineAsColTbl', '3', 'Data,4')
		select('BaseLineAsColumn$LineAsColTbl', '33300', 'Data,5')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,4(3)')
		click('Save1')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
		select_menu('Window>>zCcStore.bin>>Table:')
		select('LinesTbl', 'cell:2|store,0(222)')
		select('LinesTbl', 'cell:2|store,0(222)')
		assert_p('LinesTbl', 'Content', '[[1111, 222, 3333, 445566, 1, 11000], [1212, 12, 12, 121212, 1, 12000], [321, 33, 303, 30032003, 3, 33300]]')
##		assert_p('LinesTbl', 'Content', '[[1111, 222, 3333, 445566, 1, 11000], [321, 33, 303, 30032003, 3, 33300], [1212, 12, 12, 121212, 1, 12000]]')
		select('LinesTbl', 'cell:2|store,0(222)')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
		click('Edit1')
		assert_p('LinesTbl', 'Enabled', 'true')
		assert_p('LinesTbl', 'Content', '[[1111, 222, 3333, 445566, 1, 11000], [1212, 12, 12, 121212, 1, 12000], [321, 33, 303, 30032003, 3, 33300]]')
##		assert_p('LinesTbl', 'Content', '[[1111, 222, 3333, 445566, 1, 11000], [321, 33, 303, 30032003, 3, 33300], [1212, 12, 12, 121212, 1, 12000]]')
		select('LinesTbl', 'rows:[0,1,2],columns:[4|saleDate]')
		click('Delete2')
		click('Save1')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
