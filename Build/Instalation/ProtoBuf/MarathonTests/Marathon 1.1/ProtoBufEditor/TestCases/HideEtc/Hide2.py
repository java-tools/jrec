...
def test():
	...
	if window(commonBits.applicationName()):
		...
		click('Edit1')
		select('LinesTbl', 'rows:[3,4,5,6,7,8,9,10],columns:[4|Loc_Name]')
		select_menu('View>>Table View #{Selected Records#}')
##		select('Table2', 'rows:[3,4,5,6,7,8,9,10],columns:[4|Loc_Name]')
		select('LinesTbl', 'cell:4|Loc_Name,2(Penrith)')
...
##		select('Table1', 'cell:4|Loc_Name,2(Penrith)')
		...
		click('Go')
		select('LinesTbl', 'cell:4|Loc_Name,2(Penrith)')
		select('LinesTbl', 'cell:5|Loc_Addr_Ln1,3(Marayong)')
		assert_p('LinesTbl', 'Content', '[[5866, WA Ad Support, , ], [5015, Bankstown, Bankstown, NSW], [5019, Penrith, Penrith, NSW], [5033, Blacktown, Marayong, NSW], [5035, Rockdale, Building B,  Portside DC, NSW], [5037, Miranda, Westfield Shoppingtown, NSW], [5052, Eastwood, Marayong Offsite Reserve, NSW], [5055, Leichhardt, Marketown, NSW]]')
		select('LinesTbl', 'cell:5|Loc_Addr_Ln1,3(Marayong)')
		select('LinesTbl', 'cell:5|Loc_Addr_Ln1,3(Marayong)')
		rightclick('LinesTbl', '5|Loc_Addr_Ln1,2')
		select('LinesTbl', 'cell:5|Loc_Addr_Ln1,3(Marayong)')
		select('LinesTbl', 'cell:5|Loc_Addr_Ln1,3(Marayong)')
		select_menu('Edit>>Show / Hide Fields')
##		select('Table1', 'cell:5|Loc_Addr_Ln1,3(Marayong)')
		...
		click('Go')
		select('LinesTbl', 'cell:5|Loc_Addr_Ln1,3(Marayong)')
		select('LinesTbl', 'cell:7|Loc_Addr_Ln3,3(Marayong)')
		assert_p('LinesTbl', 'Content', '[[5866, WA Ad Support, , , , , A], [5015, Bankstown, Bankstown, Condell Park, 2200, NSW, A], [5019, Penrith, Penrith, Penrith, 2750, NSW, A], [5033, Blacktown, Marayong, Marayong, 2148, NSW, A], [5035, Rockdale, Building B,  Portside DC, Botany, 2019, NSW, A], [5037, Miranda, Westfield Shoppingtown, Miranda, 2228, NSW, A], [5052, Eastwood, Marayong Offsite Reserve, Marayong, 2148, NSW, A], [5055, Leichhardt, Marketown, Leichhardt, 2040, NSW, A]]')
		select('LinesTbl', 'cell:7|Loc_Addr_Ln3,3(Marayong)')
		rightclick('LinesTbl', '8|Loc_Postcode,4')
		select_menu('Show Column>>Brand_Id')
		select('LinesTbl', 'cell:7|Loc_Addr_Ln3,4(Botany)')
...
##		select('Table', 'true', 'Show,2')
		...
		click('Go')
		select('LinesTbl', 'cell:7|Loc_Addr_Ln3,4(Botany)')
		select('LinesTbl', 'cell:5|Loc_Addr_Ln1,4(Building B,  Portside DC)')
