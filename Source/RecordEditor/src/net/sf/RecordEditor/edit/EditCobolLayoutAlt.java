...
public class EditCobolLayoutAlt extends EditRec {
	 ...
	 */
	public EditCobolLayoutAlt(final String pInFile,
	...
	public static void main(final String[] pgmArgs) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
			public void run() {
			    ...
			    new EditCobolLayoutAlt(args.getDfltFile(), args.getInitialRow(), ReIOProvider.getInstance());
