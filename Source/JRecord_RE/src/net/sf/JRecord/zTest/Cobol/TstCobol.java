 ...
 */
	...
	private void checkFiles(String dir, String pref, int binFormat) throws Exception {
		checkFile(Constants.IO_FIXED_LENGTH, dir, pref + "Comp.cbl",   "Comp.bin", binFormat, false);
		checkFile(Constants.IO_FIXED_LENGTH, dir, pref + "Comp3.cbl", "Comp3.bin", binFormat, false);
		checkFile(Constants.IO_FIXED_LENGTH, dir, pref + "Comp4.cbl", "Comp4.bin", binFormat, false);
		checkFile(Constants.IO_FIXED_LENGTH, dir, pref + "Comp5.cbl", "Comp5.bin", binFormat, false);
		checkFile(Constants.IO_FIXED_LENGTH, dir, pref + "CompPositive.cbl", "CompPositive.bin", binFormat, true);
		checkFile(Constants.IO_FIXED_LENGTH, dir, pref + "CompSync.cbl",     "CompSync.bin", binFormat, false);
		checkFile(Constants.IO_FIXED_LENGTH, dir, pref + "CompSync1.cbl",   "CompSync1.bin", binFormat, false, len.length - 3);
		checkFile(Constants.IO_FIXED_LENGTH, dir, pref + "Comp5positive.cbl", "Comp5positive.bin", binFormat, true);
		checkFile(Constants.IO_FIXED_LENGTH, dir, pref + "Comp5Sync.cbl", "Comp5Sync.bin", binFormat, false);
		checkFile(Constants.IO_FIXED_LENGTH, dir, pref + "TextFields.cbl", "TextNums.txt", binFormat, false);
	...
	private void checkFile(int structure, String dir, String copybook, String fileName, int binFormat, boolean positive, int st) throws Exception {
		...
		String lname = TstConstants.COBOL_TEST_DIR + dir + copybook;
