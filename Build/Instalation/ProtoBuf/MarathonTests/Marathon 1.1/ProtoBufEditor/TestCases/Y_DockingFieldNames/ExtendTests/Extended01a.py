...
def test():
	...
	if window(commonBits.applicationName()):
		...
		assert_p('LineFrameTree.FileDisplay_JTbl', 'Content', '[[A, 1, , UINT64, 123, 123], [name, 2, , STRING, aa, aa]]')
		select('LineFrameTree.FileDisplay_JTbl', 'cell:Data,1(aa)')
		click('Down')
		...
		assert_p('LineFrameTree.FileDisplay_JTbl', 'Content', '[[A, 1, , UINT64, 123, 123], [name, 2, , STRING, aa, aa]]')
		click('Right')
		assert_p('LineFrameTree.FileDisplay_JTbl', 'Content', '[[A, 1, , UINT64, 44556, 44556], [name, 2, , STRING, , ]]')
		click('Down')
		...
		click('Up')
		click('Right')
		assert_p('LineFrameTree.FileDisplay_JTbl', 'Content', '[[A, 1, , UINT64, 11, 11], [name, 2, , STRING, , ]]')
		click('Down')
		click('Down')
		click('Tree View')
		...
		select('TabbedPane', 'Record: ')
		click('Right')
		assert_p('LineFrameTree.FileDisplay_JTbl', 'Content', '[[A, 1, , UINT64, 333, 333], [name, 2, , STRING, , ]]')
	close()
