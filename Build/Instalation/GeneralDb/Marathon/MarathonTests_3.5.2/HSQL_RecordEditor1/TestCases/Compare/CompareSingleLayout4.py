...
def test():
    ...
    if window('Record Editor'):
        ...
        if frame(' - Single Layout Compare:0'):
            select('Old File', '/C:/JavaPrograms/RecordEdit/HSQL/SampleFiles/Ams_PODownload_20041231_Compare.txt')
            select('New File', '/C:/JavaPrograms/RecordEdit/HSQL/SampleFiles/Ams_PODownload_20041231.txt')
            click('Right')
