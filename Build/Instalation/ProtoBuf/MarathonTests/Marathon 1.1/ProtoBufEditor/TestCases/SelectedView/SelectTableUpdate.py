...
##		select('JTreeTable', 'rows:[5,6,7],columns:[keycode]')
		select('LinesTbl', '-1621479474', '1|keycode,1')
		select('LinesTbl', '4011822', '2|saleDate,1')
		select('LinesTbl', 'cell:3|quantity,1(-1)')
		assert_p('LinesTbl', 'Content', '[[69684558, 40118, 1, 19000], [-1621479474, 4011822, -1, -19000], [69684558, 40118, 1, 5010]]')
		select('LinesTbl', 'cell:3|quantity,1(-1)')
...
##		select('JTreeTable', 'cell:saleDate,6(4011822)')
		...
		select('LinesTbl', '401182', '2|saleDate,1')
##		select('LinesTbl', '4011822', '2|saleDate,1')
		select('LinesTbl', 'cell:2|saleDate,1(401182)')
		click('BaseDisplay$HeaderToolTips', '1|keycode')
		select('LinesTbl', '169684558', '1|keycode,1')
##		select('Table', 'cell:3|quantity,1(-1)')
		select('LinesTbl', '401182', '2|saleDate,1')
...
##		assert_p('Table', 'Content', '[[69684558, 40118, 1, 19000], [169684558, 401182, -1, -19000], [69684558, 40118, 1, 5010]]')
		assert_p('LinesTbl', 'Content', '[[69684558, 40118, 1, 19000], [169684558, 401182, -1, -19000], [69684558, 40118, 1, 5010]]')
...
##		zzzzzzz
		...
		##select('LinesTbl', 'cell:keycode,0(69684558)')
...
##		select('Table', 'cell:2|saleDate,1(401182)')
		select('LinesTbl', 'cell:2|saleDate,1(401182)')
		assert_p('LinesTbl', 'Content', '[[69684558, 40118, 1, 19000], [69684558, 401182, -1, -19000], [69684558, 40118, 1, 5010]]')
		select('LinesTbl', 'cell:2|saleDate,1(401182)')
		select_menu('Utilities>>Compare with Disk')
...
##		select('Table', 'cell:2|saleDate,1(401182)')
		...
		select('LinesTbl', 'cell:2|saleDate,1(40118)')
		assert_p('LinesTbl', 'Content', '[[69684558, 40118, 1, 19000], [69684558, 40118, -1, -19000], [69684558, 40118, 1, 5010]]')
		select('LinesTbl', 'cell:2|saleDate,1(40118)')
		select_menu('Utilities>>Compare with Disk')
