...
public class ExportVelocityPnl extends ReFrame {
	...
	public ExportVelocityPnl(int dbIdx, String template, RecordRec layoutRec) {
		super("", "Export " + layoutRec.getRecordName() + " Via Velocity", null);
	...
	//	pnl.setHelpURL(Common.formatHelpURL(Common.HELP_SAVE_AS));
        ...
        pnl.addLine("Velocity Temlaye", templateFC, templateFC.getChooseFileButton())
    ...
    private void saveFile() {
    	try {
			...
			String s = "Generate Failed: " + e.getClass().getName() + " " + e.getMessage();
