 ...
 * a JScrollPane.
 *
 * From Java Tips Author: Rob Camick
 *
...
public class TextLineNumber extends JPanel implements CaretListener,
	...
	public static JScrollPane getTextLineNumber(JTextComponent textCmp, int lineSize) {
		JScrollPane ret = new JScrollPane(textCmp);
		ret.setRowHeaderView(new TextLineNumber(textCmp, lineSize));
