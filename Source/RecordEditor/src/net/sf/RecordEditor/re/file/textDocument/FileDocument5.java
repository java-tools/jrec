...
public class FileDocument5 extends AbstractDocument implements StyledDocument, Element, IReDocument {
...
//     */
//    public FileDocument5(FileView f, ITextInterface c) {
...
//	    	    StyleConstants.setFirstLineIndent(mainStyle, 16);
    ...
    public Element getParagraphElement(int pos) {
    	...
    	if (p == null) {
    		p = dsContent.getLinePositionByOffset(pos);
    	}
...
//    }
	...
	public Element getCharacterElement(int pos) {
		...
		if (ei1 >= 0) {
			Element element = getElement(ei1);
			int ei2 =  element.getElementIndex(pos) ;
			if (ei2 >= 0) {
				System.out.println(" ~~> Color Element " + pos + " / " + ei1 + " " + ei2);
				return element.getElement(ei2);
			}
			return element;
		}
