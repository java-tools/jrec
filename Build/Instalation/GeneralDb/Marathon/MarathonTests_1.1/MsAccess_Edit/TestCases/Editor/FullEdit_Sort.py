...
##		select('List', 'ams Store')
		...
		select('Table', 'Loc State', commonBits.fl('Field') + ',0')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',2(ST)')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',2(ST)')
		click('Right')
		select('Table', 'cell:' + commonBits.fl('Data') + ',4(Coffs Harbour)')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',4(Coffs Harbour)')
		click('Right')
		select('Table', 'cell:' + commonBits.fl('Data') + ',4(Albury)')
...
##		select('Table1', 'cell:10 - 35|Loc Name,0(National Ad Support)')
		select('Table', 'cell:' + commonBits.fl('Data') + ',3(National Ad Support)')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',3(National Ad Support)')
		click('Right')
		select('Table', 'cell:' + commonBits.fl('Data') + ',3(Head Office)')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',3(Head Office)')
		click('Right')
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(30-68 Taras Ave)')
		...
		click('Right')
		click('Right')
		select('Table', 'cell:' + commonBits.fl('Data') + ',4(No 2 Sydney Gate)')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',4(No 2 Sydney Gate)')
		click('RightM')
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(Cnr Grove Way & Golden Grove)')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(Cnr Grove Way & Golden Grove)')
		click('Left')
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(2-50 Murray Road)')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(2-50 Murray Road)')
		click('Left')
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(Gilchrist Drive)')
		assert_p('Table', 'Text', 'Gilchrist Drive', commonBits.fl('Data') + ',5')
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(Gilchrist Drive)')
