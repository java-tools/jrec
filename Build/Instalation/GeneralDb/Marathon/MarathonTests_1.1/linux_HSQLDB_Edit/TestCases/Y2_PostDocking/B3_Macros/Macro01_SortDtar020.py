...
def test():
	...
	if window('Record Editor'):
		...
		click('Edit1')
		select_menu('Utilities>>Run Script>>Examples>>FilterSort_DTAR020.js')
		select('TabbedPane', 'Qty < 0')
		click('Table:')
		...
		click('Qty < 0')
		select('TabbedPane', 'Qty < 0')
		assert_p('LineList.FileDisplay_JTbl1', 'Content', '[[61664713, 59, 335, -1, -17.99], [62684671, 20, 685, -1, -69.99], [69684558, 20, 280, -1, -19.00]]')
