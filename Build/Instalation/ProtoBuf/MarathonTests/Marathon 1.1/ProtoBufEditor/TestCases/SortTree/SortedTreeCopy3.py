...
def test():
	...
	if window(commonBits.applicationName()):
		...
		assert_p('LinesTbl', 'Text', '61684613', '1|keycode,2')
		...
		select('LinesTbl', 'cell:1|keycode,8(67674686)')
		...
		select_menu('View>>Table View #{Selected Records#}')
		select('JTreeTable', 'rows:[9,10],columns:[keycode]')
		select('LinesTbl', 'cell:1|keycode,0(60694698)')
		assert_p('LinesTbl', 'Content', '[[60694698, 59, 620, 40118, 1, 3990], [60664659, 59, 620, 40118, 1, 3990]]')
		select('LinesTbl', 'cell:1|keycode,0(60694698)')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
		select('JTreeTable', 'cell:Tree,4(null)')
		rightclick('JTreeTable', 'keycode,4')
		...
		select_menu('View>>Table View #{Selected Records#}')
		select('JTreeTable', 'rows:[2,3],columns:[Tree]')
		select('LinesTbl', 'cell:1|keycode,1(60664659)')
		assert_p('LinesTbl', 'Text', '59', '2|store,1')
		select('LinesTbl', 'cell:1|keycode,2(61664713)')
		assert_p('LinesTbl', 'Content', '[[60694698, 59, 620, 40118, 1, 3990], [60664659, 59, 620, 40118, 1, 3990], [61664713, 59, 335, 40118, 1, 17990], [61664713, 59, 335, 40118, -1, -17990], [61684613, 59, 335, 40118, 1, 12990]]')
