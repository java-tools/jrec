...
public class TstLargeFixedList3 extends TestCase {
	
	public void testFixed8() throws IOException, RecordException {
	...
	public void testFixed7() throws IOException, RecordException {
		Parameters.getInitialisedProperties().put(Parameters.PROPERTY_BIG_FILE_CHUNK_SIZE, "100");
		Common.OPTIONS.agressiveCompress.set(false);
		TstLargeFixedList main = new TstLargeFixedList();
		main.checkLines = true;
