...
def test():
	...
	if window('Record Editor'):
		...
		click('Right')
		select('TabbedPane', '')
		select('Table', 'product', 'Field Name,0')
		select('Table', 'store', 'Field Name,1')
		select('Table', 'date', 'Field Name,2')
		select('Table', 'cell:Field Name,2()')
		keystroke('Table', 'Down', 'Field Name,2')
		select('Table', 'dept', 'Field Name,3')
		select('Table', 'cell:Field Name,3()')
		keystroke('Table', 'Down', 'Field Name,3')
		select('Table', 'qty', 'Field Name,4')
		select('Table', 'price', 'Field Name,5')
		select('Table', '2', 'Decimal,5')
		select('Table', 'cell:Decimal,4(0)')
		...
		select('Table', 'cell:Field Name,2(date)')
...
#		select('TabbedPane', 'Fields')
		...
		if window('Delete: Wizard_DTAR020'):
			click('Yes')
		close()
