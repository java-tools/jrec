...
def test():
	...
	if window(commonBits.applicationName()):
		...
		click('Edit1')
		select('LinesTbl', 'rows:[1,2,3],columns:[4|Loc_Name]')
		click('Cut1')
		select('LinesTbl', 'cell:4|Loc_Name,1(Miranda)')
		...
		select('LinesTbl', 'cell:4|Loc_Name,5(Bass Hill)')
		click('PasteUp')
		select('LinesTbl', 'cell:5|Loc_Addr_Ln1,4(St. Mary\'s)')
		...
		select('LinesTbl', 'rows:[6,7,8],columns:[5|Loc_Addr_Ln1]')
		click('Delete1')
		select('LinesTbl', 'cell:5|Loc_Addr_Ln1,5(Penrith)')
		...
		select('LinesTbl', 'rows:[1,2,3],columns:[5|Loc_Addr_Ln1]')
		click('Paste1')
		select('LinesTbl', 'cell:5|Loc_Addr_Ln1,10(Frenchs Forest)')
		...
		select('LinesTbl', 'rows:[3,4,5],columns:[5|Loc_Addr_Ln1]')
		click('Delete1')
		select('LinesTbl', 'cell:5|Loc_Addr_Ln1,3(Marketown)')
		...
		select('LinesTbl', 'rows:[4,5,6],columns:[4|Loc_Name]')
		click('Copy1')
		select('LinesTbl', 'cell:5|Loc_Addr_Ln1,8(Ashfield Mall)')
		click('PasteUp')
		select('LinesTbl', 'cell:5|Loc_Addr_Ln1,4(St. Mary\'s)')
