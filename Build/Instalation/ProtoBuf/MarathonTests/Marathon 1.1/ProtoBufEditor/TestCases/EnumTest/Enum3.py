...
def test():
	...
	if window(commonBits.applicationName()):
		...
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 69684558, 69684558], [saleDate, 2, , 40118, 40118], [quantity, 3, , -1, -1], [price, 4, , -19000, -19000], [saleType, 5, , RETURN, RETURN], [paymentType, 6, , CREDIT_CARD, CREDIT_CARD]]')
		select('BaseLineAsColumn$LineAsColTbl', 'OTHER', 'Data,4')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Text,3(-19000)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 69684558, 69684558], [saleDate, 2, , 40118, 40118], [quantity, 3, , -1, -1], [price, 4, , -19000, -19000], [saleType, 5, , OTHER, OTHER], [paymentType, 6, , CREDIT_CARD, CREDIT_CARD]]')
		select('BaseLineAsColumn$LineAsColTbl', 'DEBIT_CARD', 'Data,5')
		select('BaseLineAsColumn$LineAsColTbl', 'DEBIT_CARD', 'Data,5')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,2(-1)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 69684558, 69684558], [saleDate, 2, , 40118, 40118], [quantity, 3, , -1, -1], [price, 4, , -19000, -19000], [saleType, 5, , OTHER, OTHER], [paymentType, 6, , DEBIT_CARD, DEBIT_CARD]]')
