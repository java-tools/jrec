...
def test():
	...
	if window('Record Editor'):
		...
		select('Table', 'cell:' + commonBits.fl('Record') + ',0(ams PO Download: Detail)')
...
##		select('Table1', 'cell:3 - 9|Pack Qty,4(50430.0000)')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',6(004507600000004)')
		assert_p('Table', 'Text', '507900000002509', commonBits.fl('Data') + ',7')
		select('Table', 'cell:' + commonBits.fl('Data') + ',6(004507600000004)')
		click('TextArea')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(33315156)')
		click('TextArea')
		select('Table', 'cell:' + commonBits.fl('Data') + ',6(000    00000000)')
		select('Table', 'cell:' + commonBits.fl('Data') + ',6(000    00000000)')
		click('TextArea')
