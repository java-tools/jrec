...
##		select('Table1', 'cell:8 - 2|Loc Type,1(ST)')
		...
		select('FileChooser', commonBits.userDir() + 'Filter'  + commonBits.fileSep() + 'xx2')
		click('Run Dialog')
		select('Table2', 'cell:Value,0(st)')
		rightclick('Table2', 'Value,0')
		select('Table2', 'cell:Value,0(st)')
		rightclick('Table2', 'Value,0')
		assert_p('Table2', 'Text', 'st', 'Value,0')
		select('Table2', 'cell:Value,0(st)')
		assert_p('Table2', 'Content', '[[Loc Type, true, Contains, st], [, true, Contains, ], [, true, Contains, ], [, true, Contains, ]]')
		select('Table2', 'cell:Value,0(st)')
		click('Filter')
...
##		select('Table1', 'cell:10 - 35|Loc Name,13(Carlingford Court)')
		select('Table', 'cell:Data,5(Dock 1, 11 Melissa Place)')
		assert_p('Table', 'Text', 'Dock 1, 11 Melissa Place', 'Data,5')
		select('Table', 'cell:Data,5(Dock 1, 11 Melissa Place)')
