...
def test():
	...
	if window(commonBits.applicationName()):
		...
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Row 2,6([19.0, -19.0, 5.01])')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Row 2,6([19.0, -19.0, 5.01])')
		click('ArrowButton')
		...
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[69684558, 69694158], [[40118, 40118, 40118], [40118, 40118, 40118]], [[1, -1, 1], [1, -1, 1]], [[19000, -19000, 5010], [19000, -19000, 5010]], [[SALE, RETURN, SALE], [SALE, RETURN, SALE]], [[19.0, -19.0, 5.01], [19.0, -19.0, 5.01]], [[19.0, -19.0, 5.01], [19.0, -19.0, 0.04567, 5.0107896]], [[\'\',\' -1\',\' -1 1\'], [\'\',\' -1\',\' -1 1\']]]')
