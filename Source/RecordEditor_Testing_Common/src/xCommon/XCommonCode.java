...
public class XCommonCode {
	...
	public static ColumnDetails[][] FILE_COLUMNS = {
			XCommonCode.AMS_LOCATION_FIELDS,
			XCommonCode.AMS_PO_KEYCODE_FIELDS,
			XCommonCode.AMS_PO_HEADER_FIELDS,
			XCommonCode.AMS_LOCATION_FIELDS,
	};
	
	public static final String[] CHARCTER_SETS = {"UTF-8", "UTF-8", "UTF-8", "cp037"};
	...
	public static String getFileName(String name) {
		return XCommonCode.class.getResource( "files/" + name).getFile();
	}
