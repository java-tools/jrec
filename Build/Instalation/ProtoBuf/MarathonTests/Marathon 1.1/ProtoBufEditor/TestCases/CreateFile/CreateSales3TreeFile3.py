...
##		select('FileNameTxtFld', commonBits.sampleDir() + 'zzCreateSales.bin')
		select('FileNameTxtFld', commonBits.sampleDir() + 'zzCreateSales3xx.bin')
...
###			assert_p('Table', 'Content', '[[department, 1, , 0, 0], [name, 2, , , ]]')
		close()
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[department, 1, , 0, 0], [name, 2, , , ]]')
...
##			assert_p('Table', 'Content', '[[keycode, 1, , 0, 0], [saleDate, 2, , 0, 0], [quantity, 3, , 0, 0], [price, 4, , 0, 0]]')
		...
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 0, 0], [saleDate, 2, , 0, 0], [quantity, 3, , 0, 0], [price, 4, , 0, 0]]')
		...
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 12345, 12345], [saleDate, 2, , 1111, 1111], [quantity, 3, , 11, 11], [price, 4, , 11000, 11000]]')
		click('Save1')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
...
##		select('JTreeTable', '')
		...
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 12345, 12345], [saleDate, 2, , 1111, 1111], [quantity, 3, , 11, 11], [price, 4, , 11000, 11000]]')
		click('Up')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[department, 1, , 321, 321], [name, 2, , Dept 321, Dept 321]]')
		click('Up')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[store, 1, , 11, 11], [name, 2, , 22, 22]]')
		click('Delete2')
		select_menu('Window>>zzCreateSales3xx.bin>>Tree View')
		click('Save1')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
