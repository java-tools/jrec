...
public class DataStoreAddCopy05 extends TestCase {
	
	private TestDataStoreAddCopy.IDataStoreCreator charCreator     = new TestDataStoreAddCopy.DataStoreCreator2(TestDataStoreAddCopy.STANDARD_STORAGE, FileDetails.CHAR_LINE);
	private TestDataStoreAddCopy.IDataStoreCreator fixedCreator    = new TestDataStoreAddCopy.DataStoreCreator2(TestDataStoreAddCopy.STANDARD_STORAGE, FileDetails.FIXED_LENGTH);
	private TestDataStoreAddCopy.IDataStoreCreator variableCreator = new TestDataStoreAddCopy.DataStoreCreator2(TestDataStoreAddCopy.STANDARD_STORAGE, FileDetails.VARIABLE_LENGTH);
