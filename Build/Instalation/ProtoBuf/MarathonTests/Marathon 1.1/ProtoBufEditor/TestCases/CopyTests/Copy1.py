...
##		select('JTreeTable', 'cell:Tree,4(null)')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,0(70)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[department, 1, , 70, 70], [name, 2, , Department: 70, Department: 70]]')
		click('Right')
		...
		click('Left')
		click('Down')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,0(64614285)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 64614285, 64614285], [saleDate, 2, , 40118, 40118], [quantity, 3, , 1, 1], [price, 4, , 22990, 22990]]')
		click('Right')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,1(40118)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 67654448, 67654448], [saleDate, 2, , 40118, 40118], [quantity, 3, , 1, 1], [price, 4, , 23000, 23000]]')
		click('Right')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Len,0()')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 67654448, 67654448], [saleDate, 2, , 40118, 40118], [quantity, 3, , -1, -1], [price, 4, , -23000, -23000]]')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Len,0()')
		click('Right')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,0(67654448)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 67654448, 67654448], [saleDate, 2, , 40118, 40118], [quantity, 3, , 1, 1], [price, 4, , 19010, 19010]]')
		click('Right')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,0(68614241)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 68614241, 68614241], [saleDate, 2, , 40118, 40118], [quantity, 3, , 1, 1], [price, 4, , 12990, 12990]]')
		click('Right')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,0(68614787)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 68614787, 68614787], [saleDate, 2, , 40118, 40118], [quantity, 3, , 1, 1], [price, 4, , 27990, 27990]]')
		click('Right')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,1(40118)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 68634061, 68634061], [saleDate, 2, , 40118, 40118], [quantity, 3, , 1, 1], [price, 4, , 27990, 27990]]')
		click('Right')
		click('Right')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,0(69654081)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 69654081, 69654081], [saleDate, 2, , 40118, 40118], [quantity, 3, , 1, 1], [price, 4, , 12990, 12990]]')
		click('Right')
		click('Right')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,0(8)')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Len,2()')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[quantity, 1, , 8, 8], [price, 2, , 166940, 166940], [count, 3, , 10, 10]]')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Len,2()')
