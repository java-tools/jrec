...
def test():
	...
	if window('Record Editor'):
		...
		select('Table', r'cell:' + commonBits.fl('Data') + ',4(E:\Work\RecordEdit\Jasper\untitled_report_1.jrxml)')
##		assert_p('TextArea', 'Text', r'E:\Work\RecordEdit\Jasper\untitled_report_1.jrxml')
		...
		click('Left')
		click('Left')
		select('Table', r'cell:' + commonBits.fl('Data') + ',4(E:\Work\RecordEdit\Jasper\DTAR107_rpt1.jrxml)')
		select('Table', r'cell:' + commonBits.fl('Text') + ',4(E:\Work\RecordEdit\Jasper\DTAR107_rpt1.jrxml)')
