...
##		select('PoList.FileDisplay_JTbl1', 'cell:3|msgstr,0(test)')
		select('PoList.FileDisplay_JTbl1', 'cell:4|comments,0(test)')

		commonBits.doSleep()
		assert_p('TextArea3', 'Text', r'''# SOME DESCRIPTIVE TITLE.
FIRST AUTHOR <EMAIL@ADDRESS>, YEAR.
src\resources\valid\escapse_comment.po''')


		assert_p('TextArea2', 'Text', 'test')
		assert_p('TextArea1', 'Text', 'test')
