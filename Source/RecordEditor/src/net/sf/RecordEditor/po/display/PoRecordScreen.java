...
implements AbstractFileDisplayWithFieldHide, IClosablePanel {
	...
	public PoRecordScreen(FileView viewOfFile, int lineNo, JTable parentTbl) {
		...
		PaneDtls[] fields = {
				...
				new PaneDtls("comments",              PoField.comments, new JTextArea(), 1, PaneDtls.NOT_HTML, 0.3),
				...
				new PaneDtls("fuzzy",    PoField.fuzzy,    new updateCheckBox("Fuzzy"),       1, PaneDtls.NOT_HTML, -1),
				new PaneDtls("Obsolete", PoField.obsolete, new updateCheckBox("obsolete"),    1, PaneDtls.NOT_HTML, -1),
				new PaneDtls("html",     PoField.msgstr,   new JEditorPane("text/html",  ""), 0, PaneDtls.IS_HTML, 0.3),
		};
