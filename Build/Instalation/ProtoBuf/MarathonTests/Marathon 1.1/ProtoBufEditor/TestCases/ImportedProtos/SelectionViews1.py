...
##		select('JTreeTable', '')
		...
		select('JTreeTable', 'rows:[9,10,11,12,13],columns:[Tree]')
		select('LinesTbl', 'cell:2|saleDate,1(40118)')
		assert_p('LinesTbl', 'Content', '[[69684558, 40118, -1, -19000], [69684558, 40118, 1, 5010], [69694158, 40118, 1, 19000], [69694158, 40118, -1, -19000], [69694158, 40118, 1, 5010]]')
		select('LinesTbl', 'cell:2|saleDate,1(40118)')
		rightclick('LinesTbl', '1|keycode,2')
		select_menu('Edit Record')
##		select('Table1', 'cell:2|saleDate,1(40118)')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,1(40118)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 69694158, 69694158], [saleDate, 2, , 40118, 40118], [quantity, 3, , 1, 1], [price, 4, , 19000, 19000]]')
...
##		select('JTreeTable', 'rows:[9,10,11],columns:[Tree]')
		...
		click('Right')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,1(40118)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 69684558, 69684558], [saleDate, 2, , 40118, 40118], [quantity, 3, , 1, 1], [price, 4, , 5010, 5010]]')
		click('Right')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,1(40118)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 69694158, 69694158], [saleDate, 2, , 40118, 40118], [quantity, 3, , 1, 1], [price, 4, , 19000, 19000]]')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
...
##		select('JTreeTable', 'rows:[9,10,11,12],columns:[keycode]')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Row 1,1(40118)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[69684558, 69684558, 69694158, 69694158], [40118, 40118, 40118, 40118], [-1, 1, 1, -1], [-19000, 5010, 19000, -19000]]')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Row 2,1(40118)')
		rightclick('BaseLineAsColumn$LineAsColTbl', 'Row 2,1')
		select_menu('Edit Record')
