...
public class TstFileChunkVb2 extends TestCase {
	...
	public void testVB21() {
		...
		tst("VB 2.1.1 ", 1, 0, 100);
		tst("VB 2.1.2 ", 12, 0, 100);
		tst("VB 2.1.3 ", 15, 0, 100);
		tst("VB 2.1.4 ", 17, 0, 100);
		
		tst("VB 2.1.5 ", 121, 0, 400);
		tst("VB 2.1.6 ", 1213, 0, 800);
		tst("VB 2.1.7 ", 1215, 0, 400);
		tst("VB 2.1.8 ", 1217, 0, 800);
	}
	
	public void testVB22() {
		Common.OPTIONS.agressiveCompress.set(false);
		
		tst("VB 2.2.1 ", System.nanoTime(), 0, 100);
		tst("VB 2.2.2 ", System.nanoTime() + 12, 0, 100);
		tst("VB 2.2.3 ", System.nanoTime() + 15, 0, 500);
		tst("VB 2.2.4 ", System.nanoTime() + 17, 0, 100);
		
		tst("VB 2.2.1 ", System.nanoTime() + 121, 0, 400);
		tst("VB 2.2.2 ", System.nanoTime() + 1213, 0, 800);
		tst("VB 2.2.3 ", System.nanoTime() + 1215, 0, 400);
		tst("VB 2.2.4 ", System.nanoTime() + 1217, 0, 800);
	}
	...
	private void tst(String desc, long seed, int firstLine, int numActions) {
		...
		FileDetails fd1 = new FileDetails(null, FileDetails.VARIABLE_LENGTH, 520, len, chgListner);
