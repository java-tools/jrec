...
public class TstLineBin extends TestCase {
    ...
    private static String copyBookName    = "Line_Test_Record";
...
//            ,  49,  75,-128,-127,-125,   0,   0 };
    ...
    public void testGetField() {
        ...
        assertEquals(" 1 GetField - Character Field " + line.getField(0, 0),
                "asdf", line.getField(0, 0));
        assertEquals(" 2 GetField - Character Field ", "    qwerty", line.getField(0, 1));
        assertEquals(" 3 GetField - Decimal Field ", "123", line.getField(0, 2));
        assertEquals(" 4 GetField - Double Field ", "121.232", line.getField(0, 3));
        assertEquals(" 5 GetField - Float  Field ", "232.343", line.getField(0, 4));
        assertEquals(" 6 GetField - Num  Field ", "3456", line.getField(0, 5));
        assertEquals(" 7 GetField - Num Right Just", "123", line.getField(0, 6));
        assertEquals(" 8 GetField - Num Zero Padded Field ", "456", line.getField(0, 7));
        assertEquals(" 9 GetField - Postive Int ", "789", line.getField(0, 8));
        ...
        assertEquals("21 GetField - Mainframe Small Int ", "31000", line.getField(0, 20));
        assertEquals("22 GetField - Mainframe Long ", "100000000000000000", line.getField(0, 21));
    ...
    public void testGetFieldText() {
        ...
        assertEquals("GetFieldText - 7 >> ", "ÏWhC", line.getFieldText(0, 4));
        // unix assertEquals("GetFieldText - 7 >> ", "ï¿½WhC", line.getFieldText(0, 4));
    }
    ...
    public void testGetFieldHex() {
        ...
        assertEquals("GetFieldHex - GetHex 3 ", "022b8716d94e5e40", line.getFieldHex(0, 3));
        assertEquals("GetFieldHex - GetHex 4 ", "cf576843", line.getFieldHex(0, 4));
    ...
    public void testSetField() throws RecordException {
        ...
        checkAssignmentText(" 6 setField - Num  Field ",      5, "7475", "7475");
        ...
        checkAssignmentText("10n setField - Assumed Decimal ", 9, "-67.4500", "-000674500");
        ...
        checkAssignmentText("10n1 setField - Assumed Decimal ", 9, "-0.0127", "-000000127");
...
/*        if (!s.equals(hexVal)) {
    ...
    public void testMainframe() {
        Line mainframeLine = defMainframeRec();
     ...
     */
    private Line defMainframeRec() {
        return new Line(copybookInt.getLayout(copyBookDTAR020),
                		recDtar020);
    }
}
