...
##		select('Filter.FieldRelationship_JTbl', 'cell:Field,0(null)')
		...
		select('Filter.FieldRelationship_JTbl', '4', 'Value,0')
...
##		select('Filter.FieldRelationship_JTbl', 'cell:Value,2()')
		...
		assert_p('Filter.FieldRelationship_JTbl', 'Content', '[[, , SALE-PRICE, true, <, 4], [, And, STORE-NO, true, Contains, 20], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ]]')
		...
		select('Filter.FieldRelationship_JTbl', 'cell:Value,2()')
		assert_p('Filter.FieldRelationship_JTbl', 'Content', '[[, , SALE-PRICE, true, <, 4], [, And, STORE-NO, true, Contains, 59], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ], [, And, , true, Contains, ]]')
		select('Filter.FieldRelationship_JTbl', 'cell:Value,2()')
		click('Filter1')
