...
public class ZCopy_ScriptRunFrame extends ReFrame {
    ...
    private KeyAdapter listner = new KeyAdapter() {
        ...
        public final void keyReleased(KeyEvent event) {
        	...
        	case KeyEvent.VK_ESCAPE:	ZCopy_ScriptRunFrame.this.doDefaultCloseAction();	break;
        	}
        }
    };
	/**
	...
	private void run() {
		...
		try {
			String scriptName = templateFC.getText();
			...
			if ("".equals(lang)) {
				...
				(new net.sf.RecordEditor.re.script.ScriptMgr())
					.runScript(lang, scriptName, data);
			}
