...
public class TstRecordIOWriter extends TestCase {
    ...
    throws IOException, RecordException {
        ...
        writeAFile(poFileName, po_Lines, poCopyBook);
    ...
    throws IOException, RecordException {
        ...
        writeAFile(dtar020FileName, dtar020Lines2Test, dtar020CopyBook);
     ...
     */
    private void writeAFile(String name, String[] line, LayoutDetail details)
    throws IOException  {
        int i;
        TextLineWriter writer = new TextLineWriter(false);

        writer.open(name);

        for (i = 0; i < line.length; i++) {
            writer.write(new Line(details, line[i]));
        }
        writer.close();    }
