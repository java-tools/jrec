...
def test():
	...
	if window('Record Editor'):
		...
		select('RecordDef.Record Name_Txt', 'zx33xzFLDg65')
...
##		click('ScrollPane$ScrollBar', 5, 43)
		...
		select('ChildRecordsJTbl', 'zx33xzFLD3', 'Tree Parent,0')
		select('ChildRecordsJTbl', 'zx33xzFLD1', 'Tree Parent,1')
		select('ChildRecordsJTbl', 'cell:Tree Parent,1(zx33xzFLD1)')
...
###		select('RecordSelectionJTbl1', '')
		...
		if window('Input'):
			select('OptionPane.textField', 'zx33xzFLDg654')
			click('OK')
		close()
