...
public class TstSplitingCobolCopybooks extends TestCase {
	...
	public void testRepeating()  throws RecordException {
		tstImport("example.cbl", CopybookLoader.SPLIT_HIGHEST_REPEATING, "EXAMPLE-");
		tstImport("example1.cbl", CopybookLoader.SPLIT_HIGHEST_REPEATING, "EXAMPLE-");
		tstImport("example2.cbl", CopybookLoader.SPLIT_HIGHEST_REPEATING, "EXAMPLE-");
		tstImport("example3.cbl", CopybookLoader.SPLIT_HIGHEST_REPEATING, "EXAMPLE-");
	}
	...
	private void tstImport(String copybook, int splitOption, String pref) throws RecordException {
