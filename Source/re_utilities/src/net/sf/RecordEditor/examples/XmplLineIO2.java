...
public final class XmplLineIO2 {
    ...
    private String salesFileOut        = installDir + "SampleFiles\\DTAR020out.bin";

    private CopyBookDbReader copybook  = new CopyBookDbReader();
    ...
    private AbstractLineWriter writer       = ioProvider.getLineWriter(fileStructure);
