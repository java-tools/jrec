...
public class DialectManager {
	...
	public static final IDialect MAINFRAME_COBOL = new DialectImp(MAINFRAME_NUMERIC_DEFINITION);
	/** GNU Cobol (https://sourceforge.net/projects/open-cobol/) **/
	public static final IDialect GNU_COBOL = new DialectImp( GNU_COBOL_NUMERIC_DEFINITION);
	/** Fujitsu PC Cobol **/
	public static final IDialect FUJITSU_COBOL = new DialectImp( FUJITSU_COBOL_NUMERIC_DEFINITION);

	private static class DialectImp implements IDialect {
