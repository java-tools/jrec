...
##		assert_p('Table', 'Content', '[[Data, 1, 1, TAR5019STPenrith                            Penrith                                 58 Leland Street                        Penrith                            2750      NSWA, T, 54]]')
		...
		assert_p('Table', 'Text', 'TAR5019STPenrith                            Penrith                                 58 Leland Street                        Penrith                            2750      NSWA', 'Data,0')
		click('Right')
		...
		select('Table', 'cell:Data,0(TAR5033STBlacktown                          Marayong                                Dock 2, 11 Melissa Place                Marayong                           2148      NSWA)')
		click('Right')
		assert_p('Table', 'Text', 'TAR5035STRockdale                           Building B,  Portside DC                2-8 Mc Pherson Street                   Botany                             2019      NSWA', 'Data,0')
	close()
