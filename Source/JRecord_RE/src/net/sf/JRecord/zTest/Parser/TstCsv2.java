...
//	};
	...
	public void testCsvRead11a() throws RecordException, IOException {
		...
		tstReadArray("CsvRead1: ", getCsvLayout(Constants.IO_CSV), 0, CSV_LINES, new String[CSV_LINES_ALT.length], CSV_LINE_FIELD);
		
		LayoutDetail schema = newCsvRecord("", Constants.IO_CSV_NAME_1ST_LINE, "", ",", "\"").asLayoutDetail();
		tstReadArray("CsvRead1: ", schema, 1, CSV_LINES, new String[CSV_LINES_ALT.length], CSV_LINE_FIELD);
	}
	...
	public void testCsvRead11b() throws RecordException, IOException {
		...
		LayoutDetail schema = newCsvRecord("", Constants.IO_CSV_NAME_1ST_LINE, "",
	...
	public void testCsvRead21a() throws RecordException, IOException {
		CommonBits.setUseCsvLine(true);
		String id = "CsvRead1: ";
		tstReadArray(id, getCsvLayout(Constants.IO_CSV), 0, CSV_LINES2, CSV_LINES2, CSV_LINE_FIELD2);
	...
	private void tstReadArray(String id, String[] lines, String[][] expected) throws RecordException, IOException {
		//LayoutDetail schema = newCsvRecord("", Constants.IO_CSV, "", ",", "\"").asLayoutDetail();
		tstReadArray(id, getCsvLayout(Constants.IO_CSV), 0, lines, lines, expected);
		
		LayoutDetail schema = newCsvRecord("", Constants.IO_CSV_NAME_1ST_LINE, "", ",", "\"").asLayoutDetail();
		tstReadArray(id, schema, 1, lines, expected);
		
		LayoutDetail schema1 = newCsvRecord("", Constants.IO_CSV_NAME_1ST_LINE, "",
				CommonCsvTests.toHex(','), CommonCsvTests.toHex('\"')).asLayoutDetail();
	...
	private static LayoutDetail getCsvLayout(int filestructure, String delim, String quote) throws RecordException {
		...
		ExternalRecord r= newCsvRecord("", filestructure, "", delim, quote);
		addCsvField(r, "Year", Type.ftChar, 0);
					addCsvField(r, "Make", Type.ftChar, 0);
					addCsvField(r, "Model", Type.ftChar, 0);
					addCsvField(r, "Description", Type.ftChar, 0);
					addCsvField(r, "Price", Type.ftChar, 0);					
	...
	private static LayoutDetail getCsvLayout2(int filestructure, String delim, String quote ) throws RecordException {
		//ParserManager.setUseNewCsvParsers(true);
		ExternalRecord rec =  newCsvRecord("", filestructure, "", ",", "\"");
										addCsvField(rec, "Field 1", Type.ftChar, 0);
										addCsvField(rec, "Field 2", Type.ftChar, 0);
										addCsvField(rec, "Field 3", Type.ftChar, 0);
	...
	public static ExternalRecord newCsvRecord(String name, int fileStructure, String fontName, String delimeter, String quote) {
	...
	public static void addCsvField(ExternalRecord r, String name, int type, int decimal) {
		r.addRecordField(new ExternalField(r.getNumberOfRecordFields() + 1, Constants.NULL_INTEGER, name, "", type, decimal, 0, "", "", "", 0));
	}
