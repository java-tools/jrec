...
public class FileDocument4 extends AbstractDocument implements StyledDocument, Element, DocumentUpdateListner {
     ...
     */
    public FileDocument4(FileView f, @SuppressWarnings("rawtypes") IDataStoreText c) {
...
//	    	    StyleConstants.setFirstLineIndent(mainStyle, 16);
    ...
    public Element getParagraphElement(int pos){
    	...
    	return getElement(p.getLineNumber());
...
//		return 0;
	...
	public Element getElement(int index) {
		IDataStorePosition linePosition = dsContent.getLinePosition(index);
