...
//	private long bytesRead = 0;
	...
	public CsvCharReader(String fieldSep, String quote, String quoteEsc) {
		this(	null,
				fieldSep.toCharArray(),
				quote.toCharArray(),
				quoteEsc.toCharArray());
	}

	public CsvCharReader(char[] eol, char[] fieldSep, char[] quote, char[] quoteEsc) {
		super();
		this.eol = eol;
