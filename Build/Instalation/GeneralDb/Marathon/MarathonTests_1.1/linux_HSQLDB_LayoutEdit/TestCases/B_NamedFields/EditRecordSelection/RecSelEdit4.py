...
####		select('ChildRecordsJTbl', 'cell:Field,1(ff2)')
		...
		select('RecordSelectionJTbl', 'cell:Field,0(fld 21)')
		assert_p('RecordSelectionJTbl', 'Content', '[[, , fld 21, =, 21]]')
		select('RecordSelectionJTbl', 'cell:Field,0(fld 21)')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
		select('ChildRecordsJTbl', 'cell:Field,1(ff2)')
...
##		select('ChildRecordsJTbl', 'cell:Field,2(ff33)')
		...
		click('Insert')
		select('RecordSelectionJTbl', 'cell:Field,0()')
		select('RecordSelectionJTbl', 'fld 31', 'Field,0')
		select('RecordSelectionJTbl', '31', 'Field Value,0')
		select('RecordSelectionJTbl', 'fld 32', 'Field,1')
		select('RecordSelectionJTbl', '32', 'Field Value,1')
		select('RecordSelectionJTbl', 'fld 32', 'Field,2')
		select('RecordSelectionJTbl', '32', 'Field Value,2')
		select('RecordSelectionJTbl', 'cell:Field Value,1(32)')
		rightclick('RecordSelectionJTbl', 'and,1')
		assert_p('RecordSelectionJTbl', 'Content', '[[, , fld 31, =, 31], [Or, , fld 32, =, 32], [, And, fld 32, =, 32]]')
		select('RecordSelectionJTbl', 'cell:Field Value,1(32)')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
		select('ChildRecordsJTbl', 'cell:Field,2(ff33)')
		select('ChildRecordsJTbl', 'cell:Child Name,1()')
