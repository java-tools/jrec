...
##		select('JTreeTable', 'rows:[8,9,10,11,12,13],columns:[Tree,keycode]')
		assert_p('LinesTbl', 'Content', '[[69684558, 40118, 1, 19000, SALE, CHEQUE], [69684558, 40118, -1, -19000, RETURN, CREDIT_CARD], [69684558, 40118, 1, 5010, SALE, DEBIT_CARD], [69694158, 40118, 1, 19000, SALE, ], [69694158, 40118, -1, -19000, RETURN, CASH], [69694158, 40118, 1, 5010, SALE, CHEQUE]]')
		select('LinesTbl', 'OTHER', '5|saleType,2')
		select('LinesTbl', 'cell:2|saleDate,2(40118)')
		assert_p('LinesTbl', 'Content', '[[69684558, 40118, 1, 19000, SALE, CHEQUE], [69684558, 40118, -1, -19000, RETURN, CREDIT_CARD], [69684558, 40118, 1, 5010, OTHER, DEBIT_CARD], [69694158, 40118, 1, 19000, SALE, ], [69694158, 40118, -1, -19000, RETURN, CASH], [69694158, 40118, 1, 5010, SALE, CHEQUE]]')
		select('LinesTbl', '', '6|paymentType,2')
		select('LinesTbl', 'cell:2|saleDate,2(40118)')
		assert_p('LinesTbl', 'Content', '[[69684558, 40118, 1, 19000, SALE, CHEQUE], [69684558, 40118, -1, -19000, RETURN, CREDIT_CARD], [69684558, 40118, 1, 5010, OTHER, ], [69694158, 40118, 1, 19000, SALE, ], [69694158, 40118, -1, -19000, RETURN, CASH], [69694158, 40118, 1, 5010, SALE, CHEQUE]]')
		select('LinesTbl', 'RETURN', '5|saleType,3')
		select('LinesTbl', 'cell:2|saleDate,3(40118)')
		assert_p('LinesTbl', 'Content', '[[69684558, 40118, 1, 19000, SALE, CHEQUE], [69684558, 40118, -1, -19000, RETURN, CREDIT_CARD], [69684558, 40118, 1, 5010, OTHER, ], [69694158, 40118, 1, 19000, RETURN, ], [69694158, 40118, -1, -19000, RETURN, CASH], [69694158, 40118, 1, 5010, SALE, CHEQUE]]')
		select('LinesTbl', 'CHEQUE', '6|paymentType,3')
		select('LinesTbl', 'cell:2|saleDate,3(40118)')
		assert_p('LinesTbl', 'Content', '[[69684558, 40118, 1, 19000, SALE, CHEQUE], [69684558, 40118, -1, -19000, RETURN, CREDIT_CARD], [69684558, 40118, 1, 5010, OTHER, ], [69694158, 40118, 1, 19000, RETURN, CHEQUE], [69694158, 40118, -1, -19000, RETURN, CASH], [69694158, 40118, 1, 5010, SALE, CHEQUE]]')
		select('LinesTbl', 'SALE', '5|saleType,4')
		select('LinesTbl', 'cell:3|quantity,4(-1)')
		assert_p('LinesTbl', 'Content', '[[69684558, 40118, 1, 19000, SALE, CHEQUE], [69684558, 40118, -1, -19000, RETURN, CREDIT_CARD], [69684558, 40118, 1, 5010, OTHER, ], [69694158, 40118, 1, 19000, RETURN, CHEQUE], [69694158, 40118, -1, -19000, SALE, CASH], [69694158, 40118, 1, 5010, SALE, CHEQUE]]')
		commonBits.doSleep()
		select('LinesTbl', '', '6|paymentType,4')
		select('LinesTbl', 'cell:3|quantity,4(-1)')
		assert_p('LinesTbl', 'Content', '[[69684558, 40118, 1, 19000, SALE, CHEQUE], [69684558, 40118, -1, -19000, RETURN, CREDIT_CARD], [69684558, 40118, 1, 5010, OTHER, ], [69694158, 40118, 1, 19000, RETURN, CHEQUE], [69694158, 40118, -1, -19000, SALE, ], [69694158, 40118, 1, 5010, SALE, CHEQUE]]')
