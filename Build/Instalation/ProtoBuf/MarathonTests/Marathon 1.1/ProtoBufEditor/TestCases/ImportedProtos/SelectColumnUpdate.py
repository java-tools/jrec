...
##		select('JTreeTable', 'rows:[5,6,7],columns:[Tree]')
		...
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[61664713, 61664713, 61684613], [40118, 40118, 40118], [1, -1, 1], [17990, -17990, 12990]]')
		select('BaseLineAsColumn$LineAsColTbl', '-11', 'Row 2,2')
		select('BaseLineAsColumn$LineAsColTbl', '-117990', 'Row 2,3')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Row 2,2(-11)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[61664713, 61664713, 61684613], [40118, 40118, 40118], [1, -11, 1], [17990, -117990, 12990]]')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Row 2,2(-11)')
