...
public class PoField extends FieldDef {
	...
	public static final PoField previousMsgidPlural
												  = new PoField("#| msgid", "previousMsgidPlural", true, false, true, true, true);
	public static final PoField fuzzy	          = new PoField(FUZZY);
	public static final PoField obsolete          = new PoField("obsolete");

	public static final int MSGSTR_PLURAL_INDEX = PoLayoutMgr.PO_LAYOUT.getRecord(0).getFieldCount();
