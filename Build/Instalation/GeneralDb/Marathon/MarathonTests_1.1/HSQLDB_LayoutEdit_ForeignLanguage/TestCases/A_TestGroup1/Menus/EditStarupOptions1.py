	...
	if window('Record Layout Definitions'):
		...
		if window('Record Editor Options Editor'):
			if commonBits.isVersion80():
				...
				assert_p('Label86', 'Text',  commonBits.fl('Size of the program when it opens'))
				assert_p('Label88', 'Text',  commonBits.fl('Space to be left at the top of the screen.'))
				assert_p('Label90', 'Text',  commonBits.fl('Space to be left at the Right of the screen.'))
