...
def test():
	...
	if window('Record Editor'):
		...
		select('RecordDef.Record Name_Txt', 'xx353xx')
...
#		select('TabbedPane', 'Child Records')
		...
		if window('Input'):
			select('OptionPane.textField', 'xx353xx22')
			click('OK')
		close()
...
##		click('*')
		...
		select('RecordList.Record Name_Txt', 'xx353xx')
...
#		select('TabbedPane', 'Child Records')
		...
		if window('Delete: xx353xx'):
			click('Yes')
		close()


		select('RecordList.Record Name_Txt', 'xx353xx22')
