...
def test():
	...
	if window(commonBits.applicationName()):
		...
		assert_p('LinesTbl', 'RowCount', '10')
		select('LinesTbl', 'cell:5|Loc_Addr_Ln1,6(Campbelltown Mall)')
		...
		select('LinesTbl', 'cell:4|Loc_Name,4(St Marys)')
		assert_p('LinesTbl', 'RowCount', '13')
		select('LinesTbl', 'rows:[9,10,11],columns:[5|Loc_Addr_Ln1]')
		select_menu('Edit>>Delete Record#{s#}')
		select('LinesTbl', 'cell:3|Loc_Type,4(ST)')
		...
		select('LinesTbl', 'cell:3|Loc_Type,5(ST)')
		...
		select('LinesTbl', 'cell:4|Loc_Name,7(Miranda)')
		assert_p('LinesTbl', 'RowCount', '13')
		select('LinesTbl', 'cell:4|Loc_Name,7(Miranda)')
