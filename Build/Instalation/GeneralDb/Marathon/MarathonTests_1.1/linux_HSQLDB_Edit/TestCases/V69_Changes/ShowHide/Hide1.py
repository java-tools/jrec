...
def test():
	...
	if window('Record Editor'):
		...
		click('Edit1')
		select('Table', 'rows:[3,4,5,6,7,8,9,10,11],columns:[10 - 35|Loc Name]')
		select_menu('View>>Table View #{Selected Records#}')
##		select('Table2', 'rows:[3,4,5,6,7,8,9,10,11],columns:[10 - 35|Loc Name]')
		select('Table', 'cell:10 - 35|Loc Name,3(Blacktown)')
		...
		select('Table', 'cell:1 - 3|Brand Id,1(TAR)')
		rightclick('Table', '1 - 3|Brand Id,1')
		select_menu('Hide Column')
		select('Table', 'cell:125 - 35|Loc Addr Ln3,1(Condell Park)')
		rightclick('Table', '125 - 35|Loc Addr Ln3,1')
		select_menu('Hide Column')
		select('Table', 'cell:160 - 10|Loc Postcode,1(2200)')
		rightclick('Table', '160 - 10|Loc Postcode,1')
		select_menu('Hide Column')
		select('Table', 'cell:170 - 3|Loc State,1(NSW)')
		rightclick('Table', '170 - 3|Loc State,1')
		select_menu('Hide Column')
		select('Table', 'cell:45 - 40|Loc Addr Ln1,2(Penrith)')
		...
		select('Table', 'cell:45 - 40|Loc Addr Ln1,2(Penrith)')
		rightclick('Table', '85 - 40|Loc Addr Ln2,3')
		select_menu('Show Column>>Brand Id')
		select('Table', 'cell:45 - 40|Loc Addr Ln1,5(Westfield Shoppingtown)')
		...
		select('Table', 'cell:85 - 40|Loc Addr Ln2,6(11 Melissa Place)')
		rightclick('Table', '85 - 40|Loc Addr Ln2,6')
		select_menu('Show Column>>Loc Postcode')
		select('Table', 'cell:85 - 40|Loc Addr Ln2,5(Cnr. Urunga Pde & The Kingsway)')
		...
		select('Table', 'cell:85 - 40|Loc Addr Ln2,5(Cnr. Urunga Pde & The Kingsway)')
		rightclick('Table', '160 - 10|Loc Postcode,6')
		select_menu('Show Column>>Loc Addr Ln3')
		select('Table', 'cell:85 - 40|Loc Addr Ln2,5(Cnr. Urunga Pde & The Kingsway)')
		rightclick('Table', '160 - 10|Loc Postcode,6')
		select_menu('Show Column>>Loc State')
		select('Table', 'cell:170 - 3|Loc State,3(NSW)')
