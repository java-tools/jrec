...
##		select('JTreeTable', '')
		...
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[keycode, 1, , 68634752, 68634752], [saleDate, 2, , 40118, 40118], [quantity, 3, , 1, 1], [price, 4, , 8990, 8990]]')
		click('Right')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,1(8990)')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,1(8990)')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[quantity, 1, , 1, 1], [price, 2, , 8990, 8990], [count, 3, , 1, 1]]')
		click('Up')
		select('BaseLineAsColumn$LineAsColTbl', 'cell:Data,0(410)')
