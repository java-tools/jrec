...
def test():
	...
	if window('Record Editor'):
		...
		select('Table', 'cell:5 - 50|STORE-NAME,2(Q Mackay)')
...
##		commonBits.save1(click)
		...
		assert_p('Table', 'Text', '401', '3 - 2|REGION-NO,1')
		select('Table', 'cell:3 - 2|REGION-NO,2(40)')
		assert_p('Table', 'Text', '40', '3 - 2|REGION-NO,2')
		select('Table', '40', '3 - 2|REGION-NO,1')
		select('Table', '40', '3 - 2|REGION-NO,1')
