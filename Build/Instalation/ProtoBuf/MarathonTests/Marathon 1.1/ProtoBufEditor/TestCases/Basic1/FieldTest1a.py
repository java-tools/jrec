...
def test():
	...
	if window(commonBits.applicationName()):
		...
		click('Edit1')
		rightclick('LinesTbl1', 'Line,2')
		select_menu('Edit Record')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[f01, 1, , 20000, 20000], [f02, 2, , 20000, 20000], [f03, 3, , 20000, 20000], [f04, 4, , 20000, 20000], [f05, 5, , 20000, 20000], [f06, 6, , 200000000, 200000000], [f07, 7, , 200000000, 200000000], [f08, 8, , 200000000, 200000000], [f09, 9, , 200000000, 200000000], [f10, 10, , 200000000, 200000000], [f11, 11, , 20000.0, 20000.0], [f12, 12, , 2.0E8, 2.0E8], [f13, 13, , false, false], [f14, 14, , , ], [f15, 15, , 200000000, 200000000], [f16, 16, , , ], [f17, 17, , SALE, SALE], [f18, 18, , , ], [f19, 19, , 0000000002, 0000000002], [f20, 20, , , ]]')
		...
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[f01, 1, , 60000, 60000], [f02, 2, , 60000, 60000], [f03, 3, , 60000, 60000], [f04, 4, , 60000, 60000], [f05, 5, , 60000, 60000], [f06, 6, , 600000000, 600000000], [f07, 7, , 600000000, 600000000], [f08, 8, , 600000000, 600000000], [f09, 9, , 600000000, 600000000], [f10, 10, , 600000000, 600000000], [f11, 11, , 60000.0, 60000.0], [f12, 12, , 6.0E8, 6.0E8], [f13, 13, , true, true], [f14, 14, , , ], [f15, 15, , 600000000, 600000000], [f16, 16, , , ], [f17, 17, , RETURN, RETURN], [f18, 18, , , ], [f19, 19, , 0000000006, 0000000006], [f20, 20, , , ]]')
