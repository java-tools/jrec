...
public class TstRecordFujitsuVbIOWriter extends TestCase {
    ...
    public void tst1file(byte[][] lines, LayoutDetail copyBook)
    throws IOException {
        ...
        binReadCheck("Standard >> ", lines, copyBook);
        binReadCheck("   Large >> ", largeFile, copyBook);
        System.out.println(".. end ..");
    }

    private void binReadCheck(String id, byte[][] lines2Test, LayoutDetail copyBook)
    throws IOException {
    ...
    throws IOException  {
        ...
        IO.writeAFile(
                LineIOProvider.getInstance().getLineWriter(Constants.IO_VB_FUJITSU),
                name, bytes, details);
    }
