...
def test():
	...
	if window(commonBits.applicationName()):
		...
		select('JTreeTable', 'rows:[6,7,8],columns:[keycode]')
		select('LinesTbl', 'cell:1|keycode,1(60694698)')
		assert_p('LinesTbl', 'Text', '64614401', '1|keycode,3')
		select('LinesTbl', 'cell:1|keycode,2(60664659)')
		assert_p('LinesTbl', 'RowCount', '7')
		select('LinesTbl', 'cell:1|keycode,3(64614401)')
		assert_p('LinesTbl', 'Content', '[[67674686, 59, 929, 40118, 1, 3990], [60694698, 59, 620, 40118, 1, 3990], [60664659, 59, 620, 40118, 1, 3990], [64614401, 59, 957, 40118, 1, 1990], [64614401, 59, 957, 40118, 1, 1990], [62684217, 59, 957, 40118, 1, 9990], [64624770, 59, 957, 40118, 1, 2590]]')
		select('LinesTbl', 'cell:1|keycode,3(64614401)')
		...
		select_menu('View>>Table View #{Selected Records#}')
##		select('JTreeTable', 'rows:[6,7],columns:[keycode]')
		select('LinesTbl', 'cell:1|keycode,0(67674686)')
		assert_p('LinesTbl', 'Text', '64614401', '1|keycode,1')
		select('LinesTbl', 'cell:1|keycode,4(64624770)')
		assert_p('LinesTbl', 'Text', '64624770', '1|keycode,4')
		select('LinesTbl', 'cell:1|keycode,3(62684217)')
		assert_p('LinesTbl', 'RowCount', '5')
		select('LinesTbl', 'cell:1|keycode,1(64614401)')
		assert_p('LinesTbl', 'Content', '[[67674686, 59, 929, 40118, 1, 3990], [64614401, 59, 957, 40118, 1, 1990], [64614401, 59, 957, 40118, 1, 1990], [62684217, 59, 957, 40118, 1, 9990], [64624770, 59, 957, 40118, 1, 2590]]')
		select('LinesTbl', 'cell:1|keycode,1(64614401)')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
		select('JTreeTable', 'cell:Tree,6(null)')
		rightclick('JTreeTable', 'keycode,6')
...
##		select('JTreeTable', 'rows:[2,3],columns:[keycode]')
		...
		assert_p('LinesTbl', 'Content', '[[61664713, 59, 335, 40118, 1, 17990], [61664713, 59, 335, 40118, -1, -17990], [61684613, 59, 335, 40118, 1, 12990], [60694698, 59, 620, 40118, 1, 3990], [60664659, 59, 620, 40118, 1, 3990]]')
		select('LinesTbl', 'cell:1|keycode,1(61664713)')
		assert_p('LinesTbl', 'RowCount', '5')
		select('LinesTbl', 'cell:1|keycode,4(60664659)')
		select('LinesTbl', 'cell:1|keycode,3(60694698)')
		assert_p('LinesTbl', 'Text', '60694698', '1|keycode,3')
		select('LinesTbl', 'cell:1|keycode,3(60694698)')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
		...
		select_menu('View>>Table View #{Selected Records#}')
##		select('JTreeTable', 'rows:[5,6,7],columns:[keycode]')
		select('LinesTbl', 'cell:1|keycode,0(64634429)')
		assert_p('LinesTbl', 'Text', '66624458', '1|keycode,1')
		select('LinesTbl', 'cell:1|keycode,4(60664659)')
		assert_p('LinesTbl', 'Text', '60664659', '1|keycode,4')
		select('LinesTbl', 'cell:1|keycode,3(60694698)')
		assert_p('LinesTbl', 'Content', '[[64634429, 20, 957, 40118, 1, 3990], [66624458, 20, 957, 40118, 1, 890], [63674861, 20, 957, 40118, 10, 2700], [60694698, 59, 620, 40118, 1, 3990], [60664659, 59, 620, 40118, 1, 3990]]')

		select('LinesTbl', 'cell:1|keycode,2(63674861)')
		assert_p('LinesTbl', 'RowCount', '5')
		select('LinesTbl', 'cell:1|keycode,2(63674861)')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
		...
		select('JTreeTable', 'rows:[4,5,6],columns:[keycode]')
		select('LinesTbl', 'cell:1|keycode,0(67674686)')
		assert_p('LinesTbl', 'Text', '67674686', '1|keycode,0')
		select('LinesTbl', 'cell:1|keycode,5(60614707)')
		assert_p('LinesTbl', 'Text', '60614707', '1|keycode,5')
		select('LinesTbl', 'cell:1|keycode,4(68654655)')
		assert_p('LinesTbl', 'Content', '[[67674686, 59, 929, 40118, 1, 3990], [60614646, 166, 60, 40118, 1, 6000], [69654084, 166, 60, 40118, 1, 6000], [69644897, 166, 60, 40118, 1, 5080], [68654655, 166, 60, 40118, 1, 5080], [60614707, 166, 60, 40118, 1, 6000]]')

		select('LinesTbl', 'cell:1|keycode,2(69654084)')
		assert_p('LinesTbl', 'RowCount', '6')
		select('LinesTbl', 'cell:1|keycode,2(69654084)')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
		select('LinesTbl', 'cell:1|keycode,4(69694158)')
		assert_p('LinesTbl', 'RowCount', '371')
		select('LinesTbl', 'cell:1|keycode,4(69694158)')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
