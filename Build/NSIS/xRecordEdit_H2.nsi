...
<OutFile default="RecordEdit_Installer_for_H2_Windows_069.1.exe"/>
...
Section "MainSection" SEC01
  ...
  <expand  inpath="..\Instalation\H2\lib\" name="properties.zip"/>
  ...
  <psc proc="normal">
    <expand  inpath="..\Instalation\H2\lib" name="h2.pack"/>
  </psc>
  File "NsisUnpack.jar"
...
;;  <expand outpath="$INSTDIR\Copybook" inpath="..\Instalation\GeneralDB\Copybook" name="*.txt" DateCheck=yes/>
  ...
  <expand overwrite=off outpath="$PROFILE\.RecordEditor\H2_Windows" inpath="..\Instalation\hsqldb_izpack\HSQLDB\" 
  ...
  <expand overwrite=off outpath="$PROFILE\.RecordEditor\H2_Windows\User\Compare"    inpath="..\Instalation\GeneralDB\User\Compare"    name="*.xml" />  
  <expand overwrite=off outpath="$PROFILE\.RecordEditor\H2_Windows\User\Filter"     inpath="..\Instalation\GeneralDB\User\Filter"     name="*.xml" />  
  <expand overwrite=off outpath="$PROFILE\.RecordEditor\H2_Windows\User\RecordTree" inpath="..\Instalation\GeneralDB\User\RecordTree" name="*.xml" />  
  <expand overwrite=off outpath="$PROFILE\.RecordEditor\H2_Windows\User\SortTree"   inpath="..\Instalation\GeneralDB\User\SortTree"   name="*.xml" />  

  <psc proc="normal">
    <expand overwrite=off outpath="$PROFILE\.RecordEditor\H2_Windows\Database" inpath="..\Instalation\H2\Database" name="*"/>
  </psc>
