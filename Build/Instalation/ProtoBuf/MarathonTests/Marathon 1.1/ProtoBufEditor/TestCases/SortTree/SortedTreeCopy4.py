...
##		select('JTreeTable', 'rows:[5,6],columns:[Tree]')
		...
		assert_p('LinesTbl', 'RowCount', '4')
		select('LinesTbl', 'cell:1|keycode,2(61684613)')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
		select('JTreeTable', 'rows:[3,4,5],columns:[Tree]')
		select_menu('View>>Table View #{Selected Records#}')
##		select('JTreeTable', 'rows:[3,4,5],columns:[Tree]')
		select('LinesTbl', 'cell:2|store,4(184)')
		assert_p('LinesTbl', 'RowCount', '210')
		select('LinesTbl', 'cell:2|store,4(184)')
		click('BasicInternalFrameTitlePane$NoFocusButton2')
...
##		select('JTreeTable', 'rows:[6,7,8],columns:[keycode]')
		...
		assert_p('LinesTbl', 'Content', '[[64614401, 59, 957, 40118, 1, 1990], [64614401, 59, 957, 40118, 1, 1990], [62684217, 59, 957, 40118, 1, 9990], [64624770, 59, 957, 40118, 1, 2590], [63604808, 20, 170, 40118, 1, 4870]]')
		select('LinesTbl', 'cell:1|keycode,3(64624770)')
		assert_p('LinesTbl', 'Text', '64624770', '1|keycode,3')
