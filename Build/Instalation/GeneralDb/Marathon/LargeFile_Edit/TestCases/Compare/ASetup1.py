...
##		select('Table1', 'cell:3 - 4|DC Number 1,0(4534)')
		select('Table', '17.0000', 'Data,1')
		select('Table', '0.0102', 'Data,2')
		...
		click('Right')
		select('Table', '14.0000', 'Data,1')
		select('Table', 'cell:Data,2(148.3200)')
		...
		select('Table', 'cell:Data,4()')
		click('Right')
		select('Table', '6', 'Data,2')
		select('Table', '51', 'Data,4')
