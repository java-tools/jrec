...
##		click(commonBits.fl('Apply'))
		...
		select('Filter.FieldRelationship_JTbl', '5.95', commonBits.fl('Value') + ',0')
...
#		select('Filter.FieldRelationship_JTbl', 'cell:' + commonBits.fl('Operator') + ',0(Contains)')
		select('Filter.FieldRelationship_JTbl', commonBits.fl('< (Numeric)'), commonBits.fl('Operator') + ',0')
#		select('Filter.FieldRelationship_JTbl', 'cell:' + commonBits.fl('Operator') + ',0(>)')
		commonBits.filter(click)
