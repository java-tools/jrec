...
def test():
	...
	if window('Record Editor'):
		...
		select('Table1', 'cell:Field,1(Loc Nbr)')
		assert_p('Table1', 'Content', '[[Brand Id, true], [Loc Nbr, true], [Loc Type, true], [Loc Name, true], [Loc Addr Ln1, true], [Loc Addr Ln2, true], [Loc Addr Ln3, true], [Loc Postcode, true], [Loc State, true], [Loc Actv Ind, true]]')
		#select('Table1', '')
