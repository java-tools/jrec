...
#		select('Table', '0', 'Parent Record,2')
		...
		if window('Open'):
##			select(commonBits.selectPane(), 'x1Ams_PODownload_20041231.txt.xml')
			select('File Name', 'x1Ams_PODownload_20041231.txt.xml')
			click('Open')
		close()

		select('JTreeTable', 'cell:PO,1(222227)')
		click('Open')
		select('FileChooser', commonBits.sampleDir() + 'x1Ams_PODownload_20041231.txt.xml')
		commonBits.doEdit(click)
...
##		if window(r'Save Changes to file: C:\Program Files\RecordEdit\HSQLDB\SampleFiles\x1Ams_PODownload_20041231.txt.xml'):
##			click('No')
##			click('No')
##		close()
	close()
