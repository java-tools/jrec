...
def test():
	...
	if window(commonBits.applicationName()):
		...
		rightclick('LinesTbl', '2|Loc_Nbr,9')
##		select('LinesTbl', 'cell:2|Loc_Nbr,0(5839)')
...
##		select('Table1', 'cell:2|Loc_Nbr,0(5839)')
		...
		click('Go')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[Loc_Nbr, 2, , 5052, 5052], [Loc_Name, 4, , Eastwood, Eastwood], [Loc_Addr_Ln1, 5, , Marayong Offsite Reserve, Marayong Offsite Reserve], [Loc_Addr_Ln3, 7, , Marayong, Marayong]]')
##		select('Table', '')
		rightclick('BaseLineAsColumn$LineAsColTbl', 'Data,2')
		select_menu('Show Locations Fields>>Loc_Actv_Ind')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[Loc_Nbr, 2, , 5052, 5052], [Loc_Name, 4, , Eastwood, Eastwood], [Loc_Addr_Ln1, 5, , Marayong Offsite Reserve, Marayong Offsite Reserve], [Loc_Addr_Ln3, 7, , Marayong, Marayong], [Loc_Actv_Ind, 10, , A, A]]')
##		select('Table', '')
		rightclick('BaseLineAsColumn$LineAsColTbl', 'Data,3')
		select_menu('Show Locations Fields>>Loc_State')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[Loc_Nbr, 2, , 5052, 5052], [Loc_Name, 4, , Eastwood, Eastwood], [Loc_Addr_Ln1, 5, , Marayong Offsite Reserve, Marayong Offsite Reserve], [Loc_Addr_Ln3, 7, , Marayong, Marayong], [Loc_State, 9, , NSW, NSW], [Loc_Actv_Ind, 10, , A, A]]')
##		select('Table', '')
		rightclick('BaseLineAsColumn$LineAsColTbl', 'Data,2')
		select_menu('Hide Column')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[Loc_Nbr, 2, , 5052, 5052], [Loc_Name, 4, , Eastwood, Eastwood], [Loc_Addr_Ln3, 7, , Marayong, Marayong], [Loc_State, 9, , NSW, NSW], [Loc_Actv_Ind, 10, , A, A]]')
		select_menu('Edit>>Show / Hide Fields')
##		assert_p('Table', 'Content', '[[Brand_Id, true], [Loc_Nbr, true], [Loc_Type, false], [Loc_Name, true], [Loc_Addr_Ln1, false], [Loc_Addr_Ln2, false], [Loc_Addr_Ln3, true], [Loc_Postcode, false], [Loc_State, true], [Loc_Actv_Ind, true]]')
		...
		click('Go')
		assert_p('BaseLineAsColumn$LineAsColTbl', 'Content', '[[Brand_Id, 1, , TAR, TAR], [Loc_Nbr, 2, , 5052, 5052], [Loc_Name, 4, , Eastwood, Eastwood], [Loc_Addr_Ln1, 5, , Marayong Offsite Reserve, Marayong Offsite Reserve], [Loc_Addr_Ln3, 7, , Marayong, Marayong], [Loc_Postcode, 8, , 2148, 2148], [Loc_State, 9, , NSW, NSW], [Loc_Actv_Ind, 10, , A, A]]')

##		select('Table', '')
		rightclick('BaseLineAsColumn$LineAsColTbl', 'Data,5')
