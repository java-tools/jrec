...
def test():
	...
	if window('File Compare'):
		...
		click(commonBits.fl('Choose File') + '1')
		...
		click('Right')
		select('TabbedPane', '')
		select('Table1', 'cell:' + commonBits.fl('Include') + ',2(true)')
		select('Table1', 'cell:' + commonBits.fl('Include') + ',5(true)')
		select('Table1', 'cell:' + commonBits.fl('Include') + ',8(true)')
		select('Table1', 'cell:' + commonBits.fl('Field') + ',5(Loc Addr Ln2)')
		...
		select('Table', 'cell:Loc Postcode,15(4870)')
		click(commonBits.fl('All Included Lines'))
