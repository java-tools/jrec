...
public class RunSavedCopy extends ReFrame {
	...
	private JButton runCompareDialogBtn = new JButton("Run Copy Dialog");
	private JButton runCompareBtn       = new JButton("Run Copy");
//	private JButton runHtmlCompareBtn   = new JButton("Run Html Copy");
