...
public class DocumentFrame extends BaseDisplay implements DocumentListener, AbstractCreateChildScreen {
	...
	public DocumentFrame(FileView view, boolean colorFields) {
	...
	protected BaseDisplay getNewDisplay(FileView view) {
		return new DocumentFrame(view, colorFields);
	}
