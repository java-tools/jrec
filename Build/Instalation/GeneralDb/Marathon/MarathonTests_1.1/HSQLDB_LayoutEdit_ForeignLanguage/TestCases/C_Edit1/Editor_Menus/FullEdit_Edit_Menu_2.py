...
##		select('Table1', 'cell:45 - 40|Loc Addr Ln1,5(Building B,  Portside DC)')
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(2-8 Mc Pherson Street)')
		assert_p('Table', 'Text', 'cell:' + commonBits.fl('Data') + ',5(2-8 Mc Pherson Street)')
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(2-8 Mc Pherson Street)')
		click('Right')
		...
		assert_p('Table', 'Text', 'Unit 2, 39-41 Allingham Street', commonBits.fl('Data') + ',5')
		...
		assert_p('Table', 'Text', 'cell:' + commonBits.fl('Data') + ',4(Penrith)')
...
##		select('Table1', 'cell:10 - 35|Loc Name,5(Rockdale)')
		...
		assert_p('Table', 'Text', 'Building B,  Portside DC', commonBits.fl('Data') + ',4')
		select('Table', 'cell:' + commonBits.fl('Data') + ',4(Building B,  Portside DC)')
		click('Right')
		select('Table', 'cell:' + commonBits.fl('Data') + ',4(Penrith)')
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(58 Leland Street)')
