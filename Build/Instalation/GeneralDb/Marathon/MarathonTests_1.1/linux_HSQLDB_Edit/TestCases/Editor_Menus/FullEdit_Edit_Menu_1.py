...
##		select('Table1', 'cell:8 - 2|Loc Type,10(ST)')
		...
		assert_p('Table', 'Text', 'Charles Hackett Drive', commonBits.fl('Data') + ',5')
		...
		assert_p('Table', 'Text', 'cell:' + commonBits.fl('Data') + ',5(58 Leland Street)')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',4(Penrith)')
		click('Right')
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(753 Hume Highway)')
		assert_p('Table', 'Text', 'cell:' + commonBits.fl('Data') + ',5(753 Hume Highway)')
		select('Table', 'cell:' + commonBits.fl('Data') + ',4(Bass Hill Plaza)')
		...
		select('Table', 'cell:' + commonBits.fl('Data') + ',4(Bass Hill Plaza)')
		click('Right')
		select('Table', 'cell:' + commonBits.fl('Data') + ',5(303 Queen Street)')
		assert_p('Table', 'Text', 'cell:' + commonBits.fl('Data') + ',5(303 Queen Street)')
		select('Table', 'cell:' + commonBits.fl('Data') + ',4(Campbelltown Mall)')
