 ...
 *
 */
public class ZoldPnl4Names extends WizardPanel {
	...
	//private TableDB typeTable = new TableDB();
     ...
     */
    public ZoldPnl4Names(AbsRowList typeList) {
        super();
    ...
    public void setValues(Details detail) throws Exception {
        ...
        recordDefinition = detail.standardRecord;
