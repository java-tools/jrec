...
/**
 * This class was copied from the excellent trove package (Version 3.0.3).
 * It retains the GNU LESSER GENERAL PUBLIC LICENSE (from trove 
 * 
 * --------------------------------------------------------------
 * 
...
//    public void addAll(int pos, int[] vals, int offset, int length ) {
//    	if (length <= 0) return;
//    	
//    	pos = Math.min(_pos, pos);
//        ensureCapacity( _pos + length + 1 );
//        //try {
//        System.arraycopy( _data, pos, _data, pos+length, _pos-pos+1 );
//
//        System.arraycopy( vals, offset, _data, pos, length );
//        _pos += length;
//    }
