...
public class DataStoreAddCopy02 extends TestCase {
	
//	private TestDataStoreAddCopy.IDataStoreCreator charCreator     = new TestDataStoreAddCopy.DataStoreCreator2(FileDetails.CHAR_LINE);
	private TestDataStoreAddCopy.IDataStoreCreator fixedCreator    = new TestDataStoreAddCopy.DataStoreCreator2(FileDetails.CHAR_LINE, FileDetails.FIXED_LENGTH);
	private TestDataStoreAddCopy.IDataStoreCreator variableCreator = new TestDataStoreAddCopy.DataStoreCreator2(FileDetails.CHAR_LINE, FileDetails.VARIABLE_LENGTH);
	private TestDataStoreAddCopy.IDataStoreCreator standardCreator 
			= new TestDataStoreAddCopy.DataStoreCreator2(FileDetails.CHAR_LINE, TestDataStoreAddCopy.STANDARD_STORAGE);
